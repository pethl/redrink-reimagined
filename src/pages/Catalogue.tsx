...
const products: Product[] = [
  ...
  { name: "Black Steel Thermo Mug", brand: "ReDrink", category: "Cups", image: blackThermoMug, description: "350ml double walled black stainless steel take out tumbler with black silicone grip band for comfort when carrying and secure anti-spill sipper. BPA & PVC free." },
